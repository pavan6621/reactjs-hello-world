...
import { Button, Card, CardContent, Divider, TextField, Typography, Container, MenuItem, InputAdornment, Autocomplete, IconButton, } from '@mui/material';
...
const AddAccount = ({ handleSubmit, initialData }) => {
    ...
    setInputValue(inputValue);
       if(isEmail) {
        ...
        if (formData.EmailAddress === '' || formData.Attachment === '' || formData.Status === ''  || formData.Organization === '' || formData.PhoneNumber === '' || formData.name === '') {
            setError5(true);
        }
        else {
                ...
                <div  >
                    <Typography variant="h6" >
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginLeft: '20px' }}>
                            ...
                            <Typography><Link to="/Account" style={{ color: " white" }}>Account/</Link></Typography>
                            <Typography>Add Account</Typography></div>
                    </Typography >
                </div>
            ...
            <Container >
                <Card sx={{ position: 'relative', marginTop: '10px' }}>
                        ...
                        {isDivVisible && (
                            ...
                            <div className='Sub-harder2'>
                                <div className='Sub-harder1' >
                                    ...
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5' sx={{ margin: '10px' }}>Phone Number</Typography> </div>
                                        <div className='Sub-harder3' >
                                            <TextField variant="outlined" size="small" fullWidth type="text"
                                                name="PhoneNumber"
                                    ...
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5' >Skype ID</Typography> </div>
                                        <div className='Sub-harder3' >
                                            <TextField variant="outlined" size="small" fullWidth type="text"
                                    ...
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5' >Organization</Typography> </div>
                                        <div className='Sub-harder3' >
                                            <TextField variant="outlined" size="small" fullWidth type="text"
                                                name="Organization"
                                    ...
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5'>Contact Name </Typography></div>
                    ...
                    >  
                                        ...
                                        <div className='Sub-harder3' >      <Autocomplete
                                            multiple
                                            ...
                                            style={{ width: 300 }}
                                            renderInput={(params) => <TextField {...params} name="ContactName" size="small"  fullWidth error={error3}
                                                helperText={error3 ? 'Please select at least one option.' : ''}   variant="outlined"  
                                                InputProps={{
                                                    ...params.InputProps,
                                                    endAdornment: (
                                                      <AddIcon
                                                        style={{ cursor: 'pointer', position: 'relative',   left:30 }}
                                    ...
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5'> Industry </Typography></div>
                                        <div className='Sub-harder3' >   <Autocomplete

                                            options={options2}
                                            getOptionLabel={(option) => option.label}
                                            style={{ width: 300 }}
                                            renderInput={(params) => <TextField {...params} sx={{ background: 'linear-gradient(to right, white 85%, lavender 15%)' }} size="small" fullWidth variant="outlined" />}
                                        /></div></div>

                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5'>Attachment </Typography></div>
                                        <div className='Sub-harder3' >
                                            <TextField component="label" size="small" fullWidth sx={{ background: 'linear-gradient(to right, white 85%, lavender 15%)' }}
                                                InputProps={{
                                                    startAdornment: (
                                                        <InputAdornment position="start">

                                                            <VisuallyHiddenInput type="file" name="Attachment" onChange={handleFileChange} />{selectedFile ? (
                                                                <p>{selectedFile.name} <CloseIcon onClick={handleFileChange5} /></p>
                                                            ) : 'enter'}
                                                    ...
                                                    endAdornment: (
                                                        <IconButton>
                                                            ...
                                                            <VerticalAlignTopIcon sx={{ position: 'relative', left: 10 }} />
                                                        </IconButton>
                                                    ),
                                                }}


                                                name="Attachment" onChange={handleFileChange}
                                            > </TextField>
                  ...
                  <div className='Sub-harder2' >
                    ...
                    onChange={handleChange12} fullWidth /></div>
                                ...
                                <div className='Sub-harder4' >
                                    ...
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5' sx={{ margin: '10px' }}>Website </Typography></div>
                                        <div className='Sub-harder3' ><TextField variant="outlined" size="small" type="text" name="Website"
                                            placeholder="Website"
                                            fullWidth />
                                        </div>
                                    </div>
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5'>Email Address</Typography></div>
                                        <div className='Sub-harder3' >  <TextField variant="outlined" size="small" type='email'
                                        name='EmailAddress'
                                    ...
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5'> Leads</Typography></div>
                                        <div className='Sub-harder3' >  <TextField
                                            variant="outlined"
                                            size="small"
                                            sx={{ background: 'linear-gradient(to right, white 85%, lavender 15%)' }}
                                    ...
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5'> Assigned To</Typography></div>
                                        <div className='Sub-harder3' >   <Autocomplete
                                            id="my-autocomplete"
                                            options={options4}
                                            getOptionLabel={(option) => option.label}
                                    ...
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5'> Tags</Typography></div>
                                        <div className='Sub-harder6' >  <TextField
                                            placeholder="Tags"
                                            fullWidth ></TextField>
                                        </div>
                                    </div>
                    ...
                    <CardContent >
                        ...
                        {isDivVisible && (
                            ...
                            <div className='Sub-harder2'>
                                <div className='Sub-harder1' >
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5' sx={{ margin: '10px' }}>Billing Address</Typography> </div>
                                        <div className='Sub-harder3' >
                                    ...
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5' >Postal Code</Typography> </div>
                                        <div className='Sub-harder3' >
                                            <TextField variant="outlined" size="small" fullWidth type="text"
                                                name="Postal Code"
                                    ...
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5' >State</Typography> </div>
                                        <div className='Sub-harder3' >
                                            <TextField variant="outlined" size="small" fullWidth type="text"
                                                name="State"
                                                placeholder="State"
                                ...
                                <div className='Sub-harder4' >
                                    ...
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5' sx={{ margin: '10px' }}>Street </Typography></div>
                                        <div className='Sub-harder3' ><TextField variant="outlined" size="small" type="text" name="Street"
                                            placeholder="Street"
                                            fullWidth />
                                        </div>
                                    </div>
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5'>City</Typography></div>
                                        <div className='Sub-harder3' >  <TextField variant="outlined" size="small"
                                            placeholder="City"
                                            fullWidth />
                                        </div>
                                    ...
                                    <div className='Sub-harder2' >
                                        <div><Typography className='Sub-harder5'> Country</Typography></div>
                                        <div className='Sub-harder3' >  <TextField variant="outlined" size="small"
                                            ...
                                            InputProps={{
                                                startAdornment: (
                                                    <InputAdornment position="start">
                                                        <ArrowDropDownIcon sx={{ position: 'relative', left: 250 }} />
                                                    </InputAdornment>
                                                ),
                                            }}
                                            fullWidth />
