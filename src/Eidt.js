  ...
  return (
    <div className='Simple'>
        ...
        <div  >
          <Typography variant="h6" >
            <div style={{ display: 'flex', justifyContent: 'space-between', marginLeft: '20px' }}>
              ...
              <Typography> Edit</Typography></div>
          </Typography >
        </div>
      ...
      <Container >
        ...
        name="name" sx={{ background: 'linear-gradient(to left, white 98%, red 2%)' }} 
        ...
        onChange={handleInputChange} fullWidth /></div>
                  </div>

                  <div className='Sub-harder2' >
                    <div><Typography className='Sub-harder5'>CloseDate</Typography></div>
                    <div className='Sub-harder3' >
                      <TextField variant="outlined"  type="Date" size="small" name="CloseDate"
        ...
        onChange={handleInputChange} fullWidth /></div>
                ...
                <div className='Sub-harder4' >
                  ...
                  <div className='Sub-harder2' >
                    ...
                    <div className='Sub-harder3' ><TextField variant="outlined" size="small" name="Contacts"
        ...
        onChange={handleInputChange} fullWidth />
                  ...
                  <div className='Sub-harder2' >
                    ...
                    name="Teams" sx={{ background: 'linear-gradient(to left, white 98%, red 2%)' }} 
