...
function AccountTable({combinedData,onEdit}) {
  ...
  const lastpage =   (tablelength % selectedValue !== 0 )? Math.ceil((rows.length/selectedValue)):(rows.length/selectedValue)
  ...
  return (
    <div className='Simple'>
      <div className='Sub-harder'>
        ...
        <div>
        <input type="text" onChange={searchdata}  placeholder='search'   style={{  width: "160px", height: "30px",marginRight: '8px', position: 'relative',    bottom: 4}}/>
        ...
        <select
            ...
            style={{    width: '160px',height: '36px',marginTop: '10px',background: 'linear-gradient(to right, white 88%, lavender 12%)', position: 'relative',    bottom: 4}}
            sx={{
              color: 'black',background: 'linear-gradient(to right, white 95%, lavender 5%)'}}
        >
        ...
        <Button sx={{
            color: 'black', marginLeft: '8px', marginRight: '8px', position: 'relative',    bottom: 4,
          ...
          <Button variant="contained" onClick={handleNavigate}
            sx={{ color: 'white', backgroundColor: 'blue', marginRight: '18px', position: 'relative',    bottom: 4 }}>
            <AddCircleIcon />
            Add Cases
          </Button>
        </div>
      ...
      <DialogActions>
        <Button onClick={handleClose} color="primary">
          Close
                    ...
                    <img src={row.Attachment}  style={{ maxWidth: '100px' }}/>
                     </TableCell>
                     <TableCell>{row.EmailAddress}</TableCell>
                      ...
                      <TableCell>
                        ...
                        <Button
                          ...
                          color="secondary"
                          startIcon={<EditIcon />}
                          onClick={() => onEdit(index, navigate("/account/AccountEidt"))}
                        >
